...
export default function AboutUs() {
    return (
     <div>
        ...
        <br></br>
       <p><b>Customer:</b> If you need temporary access to an asset eg. a DSLR Camera for a holiday trip, you can reach out to people in your neighborhood
        having those items, via our platform.</p>

        <br></br>

        <h1 className="text-3xl"><b>This is just a prototype</b></h1>
        <br></br>
        ...
        build upon trust and we will implement it in the future.</p>
